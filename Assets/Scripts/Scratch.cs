...
public class Scratch : MonoBehaviour
{
    ...
    public void AssignScreenAsMask() 
    {
        ...
        //RenderTexture renderTexture = new RenderTexture((int)a.x, (int)a.y, depth);
        ...
        //
        //
        // Color spritePixelColor = texture.GetPixel((int)sprite.textureRect.x, (int)sprite.textureRect.y);
        // Debug.Log(spritePixelColor.a);
